                ...
                <div class="inscription-contain">
                    ...
                    <form action="inscription.php" method="POST">
                        ...
                        <div class="form-input">
                            <input class="input-text" type="text" name="nom" value="" placeholder="Votre nom"><br/>
                            <span class="error"></span>
                        </div>
                        <div class="form-input">
                            <input class="input-text" type="text" name="email" value="" placeholder="Votre email"><br/>
                            <span class="error"></span>
                        </div>
                        <div class="form-input">
                            <input class="input-text" type="password" name="password" value="" placeholder="Votre mot de passe"><br/>
                            <span class="error"></span>
                        </div>
            ...
            <section class="connexion">
                ...
                <section class="form-container-ext">
                    <form action="connexion.php" method="POST">
                        ...
                        "> 
                        <div class="form-input">
                            <input class="input-text" type="text" name="email" value="" placeholder="Adresse e-mail">
                        </div>
                        <div class="form-input">
                            <input class="input-text" type="password" name="password" value="" placeholder="Mot de passe">
                        </div>
                        <div class="form-submit">
